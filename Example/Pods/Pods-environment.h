...
// CrashLogRobot
#define COCOAPODS_POD_AVAILABLE_CrashLogRobot
#define COCOAPODS_VERSION_MAJOR_CrashLogRobot 0
#define COCOAPODS_VERSION_MINOR_CrashLogRobot 1
#define COCOAPODS_VERSION_PATCH_CrashLogRobot 0
